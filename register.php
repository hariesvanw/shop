...
<html lang="en">
  ...
  <body class="text-center">
    <form action="front/store_register.php" method="post" class="form-register">
        <?php 
            if($msg === 'gagal'){
        ...
        <input name="register" value="Daftar Sekarang" type="submit" class="btn btn-lg btn-primary btn-block mb-2">
        <a href="login.php" class="mb-3">Login ?</a>
