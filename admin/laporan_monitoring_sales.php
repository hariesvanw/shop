  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Laporan Monitoring Sales</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="laporan_monitoring_sales.php">Monitoring</a></li>
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              Filter Monitoring Sales Berdasarkan Tanggal Verifikasi Pembayaran
            </div>
            <div class="card-body">
              <div class="container">
                <form action="laporan_monitoring_sales.php" method="get">
                  <div class="row">
                    <div class="col-3">
          ...
          <div class="card">
            <div class="card-header">
              <div class="row justify-content-between">
                <div class="col-6">
                  <h3 class="card-title">Tabel Data Monitoring Sales</h3>
                </div>
                <div class="col-6 text-right">
                  <button class="btn btn-secondary"
                  onclick="bukajendela('laporan/cetak_laporan_monitoring_sales.php?tgl_dari=<?php echo isset($_GET['tgl_dari']) ? $_GET['tgl_dari'] : '' ?>&tgl_sampai=<?php echo isset($_GET['tgl_sampai']) ? $_GET['tgl_sampai'] : '' ?>')"
                  >
